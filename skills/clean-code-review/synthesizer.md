...
- Expected check counts per group: clarity=17, smells=25, solid=15, arch=15, tests=13, safety=27, ddd=9
...
`{checks_run}` = sum of the expected check counts for the active groups (clarity=17, smells=25, solid=15, arch=15, tests=13, safety=27, ddd=9). Do not count headers — use the expected-count table.
...
("`checks declared`" = sum of the expected check counts for the active groups: clarity=17, smells=25, solid=15, arch=15, tests=13, safety=27, ddd=9. Do not count headers — use this expected-count table. Checks for languages absent from the diff may have run no scriptable detection.)
